...
bool ColourShader::Init(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders
	result = InitShader(device, hwnd, L"../DX12/ColourVertexShader.hlsl", L"../DX12/ColourPixelShader.hlsl");
	if (!result)
	{
		return false;
	}
...
bool ColourShader::InitShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
