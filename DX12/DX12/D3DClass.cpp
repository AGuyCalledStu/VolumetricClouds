...
bool D3DClass::Init(int screenHeight, int screenWidth, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	HRESULT result;
	...
	// Create a second depth stencil state which turns off the Z buffer for 2D rendering. The only difference is that DepthEnable is set to false, all other parameters are the same as default
	...
	// Create the state using this device
